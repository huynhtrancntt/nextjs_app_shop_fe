    ...
    const schema = yup
        .object().shape({
            ...
            passwordComfirm: yup.string()
                ...
                //.matches(PASSWORD_REG, "The Pasword is contains at least 8 characters, one uppercase, one lowercase, one number and one special case character")
                                ...
                                <Controller
                                    ...
                                    render={({ field: { onChange, onBlur, value } }) => (
                                        <CustomTextField
                                            ...
                                            onBlur={onBlur}
                                            error={errors.password ? true : false}
                                            helperText={errors?.passwordComfirm?.message}
                                        />
                                    )}
