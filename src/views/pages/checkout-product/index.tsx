...
// ** Other
import { TItemOrderProduct, TItemOrderProductBuy } from 'src/types/order-product'
...
const CheckoutProductPage: NextPage<TProps> = () => {
    ...
    const { orderItems, isLoading, isErrorCreate, isSuccessCreate, messageErrorCreate } = useSelector(
    ...
    const handleOrderProduct = () => {
        ...
        const orderItemsBuy: TItemOrderProductBuy[] = memoQueryProduct.productsSelected.map((item: TItemOrderProduct) => ({
            name: item.name,
            amount: item.amount,
            image: item.image,
            price: item.price,
    ...
    return (
        <>
            ...
            {/* phương thức vận chuyển và phương thức thanh toán */}
            <Box
                sx={{
                    backgroundColor: theme.palette.background.paper,
                    padding: '40px',
            ...
            >
                <Grid container spacing={10}>
                    <Grid item xs={6}>
                        {/* phương thức vận chuyển */}
                        <Box>
